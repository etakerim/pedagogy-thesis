...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{assets/premenne-ucebnica-mat.jpg}
\caption{Premenné}
\end{figure}
...
\caption{Cyklus}
\end{subfigure}
\caption{Zbierka úloh z matematiky}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{assets/kniha-premenne.jpg}
\caption{Premenné}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{assets/program-kozmicke-bane.jpg}
\caption{Ukážka riešeného programu}
\end{figure}


Algoritmy a programovanie v Pascale: nielen pre maturantov z predmetu informatika \cite{hedvigova_algoritmy_2020}
výraz s premennou, údajové typy, vetvenie, cyklus, cyklus v cykle, procedúry, funkcie, rekurzia, jednorozmerné polia, textový súbor, vyhľadávanie a triedenie polí, reťazce znakov, 51 úlohy a 30 úlohy pre náročnejších na opakovanie, nie je zaradené, niektoré príbehy sa opakujú

\begin{figure}[h]
\centering
\begin{subfigure}[b]{\textwidth}
\centering
\includegraphics[width=\textwidth]{assets/cykly-bez-deja-pascal.png}
\caption{Cyklus bez deja}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
\centering
\includegraphics[width=\textwidth]{assets/uloha-subory-pascal.png}
\caption{Úloha opakovania na súbory}
\end{subfigure}
\caption{Pascal}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{assets/susenie-oblecenia.png}
\caption{Úloha s príbehom na binárne vyhľadávanie}
\end{figure}


Programujeme v Pythone: učebnica informatiky pre stredné školy (\cite{kucera_programujeme_2016}) - grafické príkazy, premenné a náhodné hodnoty, opakovanie častí programu, podprogramy, klikanie myšou a ovládanie klávesnicou, podmienené príkazy, časovač, tvorba jednoduchých hier 

Učebnica vychádza z potrieb aktívnych učiteľov, ktorí sa stretávajú v Klube učiteľov informatiky vedeným autorom. Autor učebnice vyučuje 15 rokov informatiku na 1. súkromnom gymnáziu v Bratislave. praktických úloh, využíva grafické prostredie knižnice tkinter. Študenti sa na začiatku naučia kresliť grafické útvary, používať cyklus a vetvenie, ovládať program klávesnicou a myšou. V závere budú tvoriť animácie a jednoduché hry. Učebnica obsahuje aj súbor úloh na opakovanie a ukážku záverečného testu. 
...
\caption{Korytnačia grafika na cyklus}
\end{subfigure}
\caption{Pascal}
\end{figure}
...
Pracovné listy pre programovanie v Pythone pre stredné školy. Listy sú určené pre žiakov pričom nepredpokladáme žiadny výklad učiteľa. K dispozícii sú aj metodické materiály ku všetkým vyučovacím hodinám. 20 vyučovacích hodín: interaktívny režim REPL výrazy, premenné, výpisy ... prechod na grafiku v tkinter - kreslenie, náhoda, výrazy v cykle, elipsy, vetvenie, podprogramy, kreslenie myšou.

Python a korytnačia grafika: \cite{meszarosova_python_2017}
- metodika pracovných listov pre stredné školy: pohyb korytnačky, kreslenie korytnačkou, premenné,  for cyklus, funkcie, funkcie s parametrami, poloha korytnačky, náhodná poloha, vetvenie a projekt, prehľad príkazov vykresleni pohľadnice
