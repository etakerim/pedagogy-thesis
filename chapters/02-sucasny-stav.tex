...
ŠVP vyčleňuje 8 tématických celkov pre algoritmizáciu (\cite{statny_2023}):
\begin{itemize}[noitemsep,topsep=0pt]
\item Analýza problému: 
\item Jazyk na zápis riešenia:
\item Postupnosť príkazov:
\item Nástroje na interakciu:
\item Premenné:
\item Cykly:
\item Vetvenie:
\item Interpretácia zápisu riešenia: 
\end{itemize}

Cieľové požiadavky na maturitnú skúšku sú témy ešte rozšírené o vnorené príkazy cyklu a vetvenia, podprogramy s parametrami, lokálnými premennými, návratovou hodnotou a nerekurzívnym volaním. Navyše sa pridávajú jednorozmerné polia, textové súbory, zložené údajové štruktúry a použitie generátora náhodných čísel (\cite{cp_2023}).
